#!/bin/bash
# Script to analyze buffer flush timing from iedb logs
# Usage: ./scripts/analyze-flush-timing.sh iedb.log

if [ $# -eq 0 ]; then
    echo "Usage: $0 <log-file>"
    echo "Example: $0 iedb.log"
    exit 1
fi
...
echo "=== iedb Flush Timing Analysis ==="
echo ""
