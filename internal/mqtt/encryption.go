...
func (e *NoPasswordEncryptor) Encrypt(plaintext string) (string, error) {
	if plaintext != "" {
		return "", errors.New("encryption key required for passwords - set IEDB_ENCRYPTION_KEY environment variable")
	}
	return "", nil
}
...
func (e *NoPasswordEncryptor) Decrypt(ciphertext string) (string, error) {
	if ciphertext != "" {
		return "", errors.New("encryption key required to decrypt passwords - set IEDB_ENCRYPTION_KEY environment variable")
	}
	return "", nil
}
...
func GetEncryptionKey() ([]byte, error) {
	encoded := os.Getenv("IEDB_ENCRYPTION_KEY")
	if encoded == "" {
		return nil, nil
	}
