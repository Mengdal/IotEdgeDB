...
func TestLicenseStruct(t *testing.T) {
	license := &License{
		LicenseKey:    "IEDB-ENT-1234-5678-90AB-CDEF",
	...
	if license.LicenseKey != "IEDB-ENT-1234-5678-90AB-CDEF" {
...
// multi-writer feature gate. Mirrors the shape used at the cmd/iedb/main.go
...
// in the Features array; renaming it on the IEDB side would silently break
