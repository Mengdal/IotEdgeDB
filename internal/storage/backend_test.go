...
func TestLocalBackend_BasicOperations(t *testing.T) {
	...
	tmpDir, err := os.MkdirTemp("", "iedb-storage-test-*")
	if err != nil {
...
func TestLocalBackend_StatFile(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "iedb-storage-statfile-*")
	if err != nil {
...
func TestLocalBackend_ReadToAt(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "iedb-storage-readtoat-*")
	if err != nil {
		t.Fatalf("temp dir: %v", err)
	}
	defer os.RemoveAll(tmpDir)
...
func TestLocalBackend_AppendReader(t *testing.T) {
	tmpDir, err := os.MkdirTemp("", "iedb-storage-appendreader-*")
	if err != nil {
		t.Fatalf("temp dir: %v", err)
	}
	defer os.RemoveAll(tmpDir)
