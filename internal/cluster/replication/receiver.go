...
func (r *Receiver) receiveLoop() {
	...
	// triage which peer is misbehaving..
	...
	// allocation at IEDB's 200k+ entries/sec ingest rate.
	...
	for r.running.Load() {
		...
		case MsgReplicateCheckpoint:
			...
			// round 5 /The cumulativeHash itself
