...
// should not be installed. Callers in cmd/iedb/main.go should check for
...
// callbacks (e.g. cmd/iedb/main.go installs auth-state callbacks via
...
//
// Used by cmd/iedb/main.go's SetAuthCallbacks closures.
...
// but for the 5 RBAC entry types. Used by cmd/iedb/main.go's
