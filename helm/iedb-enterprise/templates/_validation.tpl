...
{{- define "iedb-enterprise.validate" -}}
{{- include "iedb-enterprise.validate.writerReplicas" . -}}
{{- include "iedb-enterprise.validate.license" . -}}
{{- include "iedb-enterprise.validate.sharedSecret" . -}}
{{- include "iedb-enterprise.validate.tls" . -}}
{{- include "iedb-enterprise.validate.minioCredentials" . -}}
{{- include "iedb-enterprise.validate.externalStorageCredentials" . -}}
{{- end }}
...
*/}}
{{- define "iedb-enterprise.validate.writerReplicas" -}}
...
*/}}
{{- define "iedb-enterprise.validate.license" -}}
{{- if and (not .Values.license.existingSecret) (not .Values.license.key) -}}
{{- $existing := lookup "v1" "Secret" .Release.Namespace (include "iedb-enterprise.licenseSecretName" .) -}}
{{- if not $existing -}}
...
*/}}
{{- define "iedb-enterprise.validate.sharedSecret" -}}
{{- if and (not .Values.cluster.sharedSecret.existingSecret) (not .Values.cluster.sharedSecret.value) -}}
{{- $existing := lookup "v1" "Secret" .Release.Namespace (include "iedb-enterprise.sharedSecretName" .) -}}
{{- if not $existing -}}
...
*/}}
{{- define "iedb-enterprise.validate.tls" -}}
...
*/}}
{{- define "iedb-enterprise.validate.minioCredentials" -}}
...
{{- $existing := lookup "v1" "Secret" .Release.Namespace (include "iedb-enterprise.minioSecretName" .) -}}
{{- if not $existing -}}
...
*/}}
{{- define "iedb-enterprise.validate.externalStorageCredentials" -}}
...
{{- $existing := lookup "v1" "Secret" .Release.Namespace (include "iedb-enterprise.objectStorageSecretName" .) -}}
{{- if not $existing -}}
